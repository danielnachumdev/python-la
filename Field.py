...
class Field:
    def __init__(self, name: Fields, degree: int = 1, modulu: int = 1) -> None:
...
DefaultRationalField = RationalField(Fields.Q, 1, 1)
...
DefaultRealField = RealField(Fields.R, 1, 1)
...
DefaultComplexField = ComplexField(Fields.C, 1, 1)
